function listCouponInteractor(data, config, args, ext, cb){
	...
	var menu_obj = {menu_items: [
			...
			{link: '/coupon', value: 'Coupons', active: 'active', sr: '<span class="sr-only">(current)</span>'},
			{link: '/label', value: 'Labels'},
			{link: '/transaction', value: 'Transactions'}
	]};
	var coupon_arr = [
		{coupon_id: 'a0', num_of_unredeemed: '200'},
		{coupon_id: 'a1', num_of_unredeemed: '99'},
		{coupon_id: 'a2', num_of_unredeemed: '12'}
	];
	return cb(null, {
		menu_items: menu_obj.menu_items,
...
module.exports = listCouponInteractor;