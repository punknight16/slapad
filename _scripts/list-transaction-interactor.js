function listTransactionInteractor(data, config, args, ext, cb){
	...
	var menu_obj = {menu_items: [
			...
			{link: '/label', value: 'Labels'},
			{link: '/transaction', value: 'Transactions', active: 'active', sr: '<span class="sr-only">(current)</span>'}
	]};
	var transaction_arr = [
		{transaction_id: 'jinsoo gamer lounge purchase 100 coupons', amount: 100.00},
		{transaction_id: 'punknight print jinsoo lounge coupon', amount: -1.00},
		{transaction_id: 'kyujin print jinsoo lounge coupon', amount: -1.00},
	];
	return cb(null, {
		menu_items: menu_obj.menu_items,
...
module.exports = listTransactionInteractor;