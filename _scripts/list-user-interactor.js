function listUserInteractor(data, config, args, ext, cb){
	...
	var menu_obj = {menu_items: [
			{link: '/user', value: 'Users', active: 'active', sr: '<span class="sr-only">(current)</span>'},
			{link: '/coupon', value: 'Coupons'},
			{link: '/label', value: 'Labels'},
			{link: '/transaction', value: 'Transactions'}
	]};
	var user_arr = [
		{cred_id: 'c0', engagements_per_day: '6'},
		{cred_id: 'c1', engagements_per_day: '4'},
		{cred_id: 'c2', engagements_per_day: '1'}
	];
	return cb(null, {
		menu_items: menu_obj.menu_items,
		user_arr: user_arr,
